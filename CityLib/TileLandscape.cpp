...
void TileLandscape::Update(double elapsed)
{
    ...
    if(zombies->GetCount() > 0)
    {
        ...
        //zombie visitor
        ZombieDistribution visitor = ZombieDistribution(available);
        //surroudingtiles(visitor)
        NeighborAccept(&visitor);

        // This line will be replaced:
        int undistributable = visitor.Distribute();
 ...
 */
void TileLandscape::NeighborAccept(TileVisitor* visitor)
{
    Tile::NeighborAccept(visitor);
    visitor->VisitLandscape(this);
}
