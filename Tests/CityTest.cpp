...
public:
    ...
    virtual void VisitLandscape(TileLandscape* landscape) override { mNumLandscapes++; }
    virtual void VisitGarden(TileGarden* garden) override { mNumGardens++; }
    virtual void VisitWater(TileWater* water) override { mNumWater++; }
...
TEST(CityTest, Visitor)
{
    ...
    ASSERT_EQ(0, visitor.mNumWater) <<
                                    L"Visitor number of water";
